                ...
                <Input
                  ...
                  info={
                    <span>
                      ...
                      <code>{"{endpoint_parameters}"}</code> that can be passed
                      to the backends. URLs ending in <code>/*</code> are
                        ...
                        <Input
                          ...
                          info={
                            <span>
                              ...
                              here any <code>{"{parameters}"}</code> defined in
                              the parent endpoint. Also see{" "}
